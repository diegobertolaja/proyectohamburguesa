...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/admin/sistema/estado">Estados</a></li>
...
?>
            ...
            <div class="row">
                ...
                <label>Nombre: *</label>
                    <input type="text" id="txtNombre" name="txtNombre" class="form-control" value="{{ $estado->curriculum }}" required>
                </div>
                </div>
                </form>
