...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/admin/sistema/clientes">Clientes</a></li>
...
?>
            ...
            <div class="row">
               ...
               <div class="form-group col-lg-6">
                <label>Mail: *</label>
                    <input type="text" id="txtMail" name="txtMail" class="form-control" value="{{ $cliente->mail }}" required>
                </div>
                <div class="form-group col-lg-6">
                <label>DNI: *</label>
